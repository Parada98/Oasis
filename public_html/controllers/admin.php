<?php
    ...
    // require_once("php/validar_session.php");
    ...
    class Admin extends Controller
    {
        ...
        function perfil()
        {
            ...
            session_unset();
            $_SESSION['id_usuario'] = $id;
            $this->view->datos = $this->model->perfil(['id_usuario' => $_SESSION['id_usuario']]);
        ...
        public function  autor_buscar()
        {
            $palabra= $_POST['q'] ;
            $this->view->dato= $this->model->autor_buscar(['palabra'=> $palabra]);
            include('php/autor.php');
            imprimir($this->view->dato);
        }
        public function  libro_buscar()
        {
            $palabra= $_POST['q'] ;
            $this->view->dato= $this->model->libro_buscar(['palabra'=> $palabra]);
        ...
        {
            $palabra= $_POST['q'] ;
            $this->view->dato= $this->model->cliente_buscar(['palabra'=> $palabra]);
        ...
        {
            $palabra= $_POST['q'] ;
            $this->view->dato= $this->model->usuario_buscar(['palabra'=> $palabra]);
            include('php/usuario.php');
            imprimir($this->view->dato);
        }

        public function  editorial_buscar()
        {
            $palabra= $_POST['q'] ;
            $this->view->dato= $this->model->editorial_buscar(['palabra'=> $palabra]);
            include('php/editorial.php');
            imprimir($this->view->dato);
