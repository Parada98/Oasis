<?php
    ...
    <div> 
        ...
        <input type="text" id="bus" value=" " placeholder="Buscar un libro" class="align-items-right m-1" name="bus" onkeyup="loadXMLDoc()" required />
        <div id="myDiv"></div>
...
xmlhttp.open("POST","<?php print(constant('URL')); ?>admin/editorial_buscar",true);
