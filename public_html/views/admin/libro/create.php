        ...
        <form class="w-75" action="<?php print constant('URL'); ?>admin/libro_insert" method="POST"  enctype="multipart/form-data">
           <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="color" name="color" aria-describedby="textHelp" placeholder="Ingresa tu color">
            </div>
            <div class="form-group">
                <label for="estante">Estante</label>
                <input type="text" class="form-control" id="estante" name="estante" aria-describedby="textHelp" placeholder="Ingresa el estante">
            </div>
            <div class="form-group">
                <label for="numero_paginas">Numero paginas</label>
                <input type="text" class="form-control" id="numero_paginas" name="numero_paginas" aria-describedby="textHelp" placeholder="Ingresa el numero pagina">
            </div>
            <div class="form-group">
                <label for="descripcion">Descripcion</label>
                <input type="text-area" class="form-control" id="descripcion" name="descripcion" aria-describedby="textHelp" placeholder="Ingresa la descripcion">
            </div>
            <div class="form-group">
                <label for="estado">Estado</label>
                <input type="text" class="form-control" id="estado" name="estado" aria-describedby="textHelp" placeholder="Ingresa el estado">
            </div>
            <div class="form-group">
                <label for="precio">Precio</label>
                <input type="text" class="form-control" id="precio" name="precio" aria-describedby="textHelp" placeholder="Ingresa el precio">
            </div>
            <div class="form-group">
