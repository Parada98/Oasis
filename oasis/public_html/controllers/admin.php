<?php
    ...
    class Admin extends Controller
    {
        ...
        public function libro_update2()
        {
            ...
            $_SESSION['id_editorial'] = isset($_POST['id_editorial']) ? $_POST['id_editorial'] : $_SESSION['id_editorial'];
            $this->view->msj = false;
            if($this->model->libro_update2(['id_libro' => $_SESSION['id_libro'], 'nombre' => $_SESSION['nombre'], 'color' => $_SESSION['color'], 'estante' => $_SESSION['estante'], 'numero_paginas' => $_SESSION['numero_paginas'], 'descripcion' => $_SESSION['descripcion'], 'estado' => $_SESSION['estado'], 'precio' =>  $_SESSION['precio'], 'id_autor' =>  $_SESSION['id_autor'], 'id_editorial' =>  $_SESSION['id_editorial']]))
                $this->view->msj = true;
            $this->view->datos = $this->model->libro_update(['id_libro' => $_SESSION['id_libro']]);
            $this->view->render('admin/libro/update');
        }
