    ...
    <div class="row d-flex justify-content-center m-5">
        ...
        <form class="w-75" action="<?php print constant('URL'); ?>admin/usuario_update2" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value='<?php print $apellido; ?>' id="apellido" name="apellido" aria-describedby="textHelp" placeholder="Ingresa tu apellido">
            </div>
            <div class="form-group">
                <label for="usuario">Usuario</label>
                <input type="text" class="form-control" value='<?php print $usuario; ?>' id="usuario" name="usuario" aria-describedby="textHelp" placeholder="Ingresa tu nuevo usuario" required>
            </div>
            <div class="form-group">
                <label for="contrasena">Constraseña</label>
                <input type="text" class="form-control" id="contrasena" name="contrasena" aria-describedby="textHelp" placeholder="Ingresa tu nueva constraseña">
            </div>
            <div class="row d-flex justify-content-center">
